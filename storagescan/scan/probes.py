...
PROBES: Tuple[Probe, ...] = (
    ...
    Probe("xcode.simulator_caches", "Simulator caches",
          ("Library/Developer/CoreSimulator/Caches",),
          "Simulator caches. Regenerated the next time you boot a simulator."),
    Probe("xcode.simulator_devices", "Simulator devices",
          ("Library/Developer/CoreSimulator/Devices",),
          "Every simulator you have created, including ones you still use. "
          "Prefer deleting unavailable devices over this whole folder.",
    ...
    Probe("uv.cache", "uv cache", (".cache/uv",),
          "Python package cache. Regenerated on the next install.",
          "uv cache prune"),
    Probe("bun.cache", "Bun cache", (".bun/install/cache",),
          "Package tarballs. Regenerated on the next install.",
          "bun pm cache rm"),
    Probe("huggingface.cache", "Hugging Face cache",
          (".cache/huggingface",),
          "Downloaded models and datasets. Re-fetched on demand."),
    Probe("ollama.models", "Ollama models", (".ollama/models",),
          "Local LLM weights. Re-download with ollama pull."),
